    ...
    return Container(
      child: Column(
        ...
        children:[
          ...
          Positioned(left: 320,top:425 ,child: FloatingActionButton(onPressed: (){},backgroundColor: Colors.indigo[400], child:Icon(Icons.attach_file)))
          ],),
...
class HomePageCard extends StatelessWidget 
{
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top:10.0, bottom: 60.0, left: 10.0, right: 10.0),
      child: Container(
